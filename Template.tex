...
%pauta para incluir "Pauta" en titulo y respuestan en ambiente \begin{solution} ... \end{solution}
\usepackage[fms171,repu,borrador,pauta]{mat-unab}

\usepackage{slashbox} % Para tablas de doble entrada
